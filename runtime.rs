    ...
    impl _parity_scale_codec::Decode for Event {
        fn decode<DecIn: _parity_scale_codec::Input>(
            ...
            match input.read_byte()? {
                x if x == 0u8 as u8 => Ok(Event::frame_system({
                    let res = _parity_scale_codec::Decode::decode(input);
                    match res {
                ...
                x if x == 4u8 as u8 => Ok(Event::pallet_grandpa({
                    let res = _parity_scale_codec::Decode::decode(input);
                    match res {
                        Err(_) => {
                ...
                x if x == 5u8 as u8 => Ok(Event::pallet_balances({
                    let res = _parity_scale_codec::Decode::decode(input);
                    match res {
                        Err(_) => {
                ...
                x if x == 7u8 as u8 => Ok(Event::pallet_sudo({
                    let res = _parity_scale_codec::Decode::decode(input);
                    match res {
                ...
                x if x == 8u8 as u8 => Ok(Event::pallet_template({
                    let res = _parity_scale_codec::Decode::decode(input);
                    match res {
                        Err(_) => {
                            return Err("Error decoding field Event :: pallet_template.0".into())
                        }
                        Ok(a) => a,
                    }
                })),
...
impl core::fmt::Debug for Event {
    fn fmt(&self, fmt: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            Self::pallet_template(ref a0) => {
                fmt.debug_tuple("Event::pallet_template").field(a0).finish()
            }
            _ => Ok(()),
        }
    }
...
impl From<pallet_template::Event<Runtime>> for Event {
    fn from(x: pallet_template::Event<Runtime>) -> Self {
        Event::pallet_template(x)
    }
}
impl ::frame_support::sp_std::convert::TryInto<pallet_template::Event<Runtime>> for Event {
    type Error = ();
    fn try_into(
        self,
    ) -> ::frame_support::sp_std::result::Result<pallet_template::Event<Runtime>, Self::Error> {
        match self {
...
impl Runtime {
    ...
    pub fn outer_event_metadata() -> ::frame_support::event::OuterEventMetadata {
        ::frame_support::event::OuterEventMetadata {
            ...
            events: ::frame_support::event::DecodeDifferent::Encode(&[
                ...
                (
                    "pallet_template",
                    ::frame_support::event::FnEncode(pallet_template::Event::<Runtime>::metadata),
                ),
            ]),
        }
    }
    ...
    pub fn __module_events_pallet_template() -> &'static [::frame_support::event::EventMetadata] {
        pallet_template::Event::<Runtime>::metadata()
    }
}
pub struct Origin {
    caller: OriginCaller,
...
const _: () = {
    ...
    impl _parity_scale_codec::Decode for OriginCaller {
        fn decode<DecIn: _parity_scale_codec::Input>(
            ...
            match input.read_byte()? {
                x if x == 0u8 as u8 => Ok(OriginCaller::system({
                    let res = _parity_scale_codec::Decode::decode(input);
                    match res {
                        Err(_) => {
...
pub type TemplateModule = pallet_template::Module<Runtime>;
pub type Kitties = pallet_kitties::Module<Runtime>;
type AllModules = ((
    Kitties,
    (
        TemplateModule,
    ...
    for PalletInfo
{
    fn index<P: 'static>() -> Option<usize> {
        ...
        if type_id == self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: sp_std :: any :: TypeId :: of :: < Kitties > ( ) { return Some ( 9usize ) }
        None
    }
    fn name<P: 'static>() -> Option<&'static str> {
        ...
        if type_id == self :: sp_api_hidden_includes_construct_runtime :: hidden_include :: sp_std :: any :: TypeId :: of :: < Kitties > ( ) { return Some ( "Kitties" ) }
        None
    }
}
pub enum Call {
...
const _: () = {
    ...
    impl _parity_scale_codec::Decode for Call {
        fn decode<DecIn: _parity_scale_codec::Input>(
            ...
            match input.read_byte()? {
                x if x == 0u8 as u8 => Ok(Call::System({
                    let res = _parity_scale_codec::Decode::decode(input);
                    match res {
                ...
                x if x == 1u8 as u8 => Ok(Call::RandomnessCollectiveFlip({
                    let res = _parity_scale_codec::Decode::decode(input);
                    match res {
                        Err(_) => {
                            return Err(
                ...
                x if x == 2u8 as u8 => Ok(Call::Timestamp({
                    let res = _parity_scale_codec::Decode::decode(input);
                    match res {
                ...
                x if x == 4u8 as u8 => Ok(Call::Grandpa({
                    let res = _parity_scale_codec::Decode::decode(input);
                    match res {
                ...
                x if x == 5u8 as u8 => Ok(Call::Balances({
                    let res = _parity_scale_codec::Decode::decode(input);
                    match res {
                ...
                x if x == 8u8 as u8 => Ok(Call::TemplateModule({
                    let res = _parity_scale_codec::Decode::decode(input);
                    match res {
                        Err(_) => {
    ...
    pub fn dispatch(method: &str, mut __sp_api__input_data: &[u8]) -> Option<Vec<u8>> {
        match method {
            ...
            "AuraApi_slot_duration" => Some(
                self::sp_api_hidden_includes_IMPL_RUNTIME_APIS::sp_api::Encode::encode(&{
                    let ( ) : ( ) = match self :: sp_api_hidden_includes_IMPL_RUNTIME_APIS :: sp_api :: DecodeLimit :: decode_all_with_depth_limit ( self :: sp_api_hidden_includes_IMPL_RUNTIME_APIS :: sp_api :: MAX_EXTRINSIC_DEPTH , & __sp_api__input_data ) { Ok ( res ) => res , Err ( e ) => { :: std :: rt :: begin_panic_fmt ( & :: core :: fmt :: Arguments :: new_v1 ( & [ "Bad input data provided to " , ": " ] , & match ( & "slot_duration" , & e . what ( ) ) { ( arg0 , arg1 ) => [ :: core :: fmt :: ArgumentV1 :: new ( arg0 , :: core :: fmt :: Display :: fmt ) , :: core :: fmt :: ArgumentV1 :: new ( arg1 , :: core :: fmt :: Display :: fmt ) ] , } ) ) } } ;
                    #[allow(deprecated)]
            ...
            "AuraApi_authorities" => Some(
                self::sp_api_hidden_includes_IMPL_RUNTIME_APIS::sp_api::Encode::encode(&{
                    let ( ) : ( ) = match self :: sp_api_hidden_includes_IMPL_RUNTIME_APIS :: sp_api :: DecodeLimit :: decode_all_with_depth_limit ( self :: sp_api_hidden_includes_IMPL_RUNTIME_APIS :: sp_api :: MAX_EXTRINSIC_DEPTH , & __sp_api__input_data ) { Ok ( res ) => res , Err ( e ) => { :: std :: rt :: begin_panic_fmt ( & :: core :: fmt :: Arguments :: new_v1 ( & [ "Bad input data provided to " , ": " ] , & match ( & "authorities" , & e . what ( ) ) { ( arg0 , arg1 ) => [ :: core :: fmt :: ArgumentV1 :: new ( arg0 , :: core :: fmt :: Display :: fmt ) , :: core :: fmt :: ArgumentV1 :: new ( arg1 , :: core :: fmt :: Display :: fmt ) ] , } ) ) } } ;
                    #[allow(deprecated)]
                    <Runtime as sp_consensus_aura::runtime_decl_for_AuraApi::AuraApi<
                        Block,
                        AuraId,
            ...
            "GrandpaApi_grandpa_authorities" => Some(
                self::sp_api_hidden_includes_IMPL_RUNTIME_APIS::sp_api::Encode::encode(&{
                    let ( ) : ( ) = match self :: sp_api_hidden_includes_IMPL_RUNTIME_APIS :: sp_api :: DecodeLimit :: decode_all_with_depth_limit ( self :: sp_api_hidden_includes_IMPL_RUNTIME_APIS :: sp_api :: MAX_EXTRINSIC_DEPTH , & __sp_api__input_data ) { Ok ( res ) => res , Err ( e ) => { :: std :: rt :: begin_panic_fmt ( & :: core :: fmt :: Arguments :: new_v1 ( & [ "Bad input data provided to " , ": " ] , & match ( & "grandpa_authorities" , & e . what ( ) ) { ( arg0 , arg1 ) => [ :: core :: fmt :: ArgumentV1 :: new ( arg0 , :: core :: fmt :: Display :: fmt ) , :: core :: fmt :: ArgumentV1 :: new ( arg1 , :: core :: fmt :: Display :: fmt ) ] , } ) ) } } ;
